            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link text-primary fw-bold" href="<%= ctx %>/admin/credits">
                        <i class="bi bi-cash-coin me-1"></i> Gestion des Crédits
                    </a>
                </li>
            </ul>
        </div>
...
<div class="container w-50 bg-white mt-5 border border-light rounded-circle mb-5">
    <div class="card-body text-center">
        ...
        <!-- Ajout des cartes de raccourcis -->
            ...
            <div class="col-md-6">
                <div class="card shadow-sm">
                    <div class="card-body">
                        ...
                        <a href="<%= ctx %>/users" class="btn btn-outline-primary">Accéder</a>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="card shadow-sm">
                    <div class="card-body">
                        <h5 class="card-title text-primary">
                            <i class="bi bi-cash-coin me-2"></i> Crédits
                        </h5>
                        <p class="card-text">Gérer les demandes de crédit</p>
                        <a href="<%= ctx %>/admin/credits" class="btn btn-outline-primary">Accéder</a>
                    </div>
                </div>
            </div>
        </div>
